...
\chapter{Method}
\label{ch:method}
As already highlighted in Ch. \ref{ch:introduction} and~\ref{ch:related_work}
...
Most of the time is spent trying to get a useful representation of the state, which is then used to learn the policy.
...
The architecture of our agents is divided into two main components, and it is showed in Fig.~\ref{fig:main}
...
ATTENTIONZE DA FINIRE!!
Combining different FMs is a challenging task, as each model provides a different perspective on the environment.
