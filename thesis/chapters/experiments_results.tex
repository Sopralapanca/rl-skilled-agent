...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{1\textwidth}
        ...
        \caption{The first scenario depicts the early stages of the game. The agent assigns more weight to SR and VOS.}
    ...
    \begin{subfigure}[b]{1\textwidth}
        ...
        \caption{The second scenario shows the late stages of the game. SR becomes less relevant and the agent assigns more weight to OKK and VOS.}
...
The fact that regularization techniques did not solve the problem may suggest that the FMs are already too informative for these two games.
...
While in \textit{Breakout} it is faster to learn on the first part of the training, and in the end DQL results a little bit better.
...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{Cumulative reward during training of different agents, comparing WSA and DQL. Each subfigure shows the mean score, with shaded areas indicating the standard deviations, across multiple agents.}
...
\begin{table}[ht]
    \begin{center}
        ...
        \end{tabular}
    \end{center}
    \caption{The table shows the number of trainable parameters of the whole model, from the smallest configuration to the biggest one.}
    \label{tab:parameters}
\end{table}

We notice how for some agents the number of parameters is higher than an end-to-end PPO.
The aim of our work is to provide a more general and effective solution to RL problems, and we did not consider the number of parameters as a constraint.